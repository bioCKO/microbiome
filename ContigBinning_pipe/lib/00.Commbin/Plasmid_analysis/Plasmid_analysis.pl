...
my $ntdb = ($opt{plasmdb} || "/PROJ/MICRO/share/MicroGenome_pipeline/MicroGenome_pipeline_v5.0/database/plasmid_database/20140417/plasmid20140417.fa");
...
my ($extract_seq_p,$blast_parser,$stat_coverage,$super_worker_p,$cut_seq_p) = (
    ...
    "perl $Bin/blast_parser.pl",
    "perl $Bin/stat_plasmid.pl",
