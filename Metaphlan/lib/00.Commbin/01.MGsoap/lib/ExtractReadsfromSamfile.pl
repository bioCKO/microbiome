...
Usage:  $0 <reads1.fq> <reads2.fq> <soap.[PE/SE].file1 soap.[PE/SE].file2 soap.[PE/SE].file3...> <output prefix>
Note:
...
open NOSAMFQ1,">:gzip","$prefix.fq1.gz" || die $!;
open NOSAMFQ2,">:gzip","$prefix.fq2.gz"|| die $!;
