...
## set default options
my ( $Pinfo, $outdir, $shdir, $fq_pattern, $adapter_pattern, @hostfa, $alnP, $alnopt, $filteropt, $notrun, $qsubopt, $help, $qsubhelp, $filterhelp,$locate,$step,$bvf,$svf,$hvf,$dvf,$read_len,
);
$alnP            = "soap";
$outdir          = abs_path("./");
...
open WORK,">$shdir/work.sh";#yu 2015-11-10
if($notrun){
    print WORK "cd $shdir\n$qsub_run\n";
	exit;
}
